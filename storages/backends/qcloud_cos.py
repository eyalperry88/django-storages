# QCloud COS storage backend for Django.
# Author: Eyal Perry <eyal.perry88@gmail.com>
# License: ???
#
# Modeled on the Google Cloud storage
import mimetypes
...
try:
    ...
    from qcloud_cos import StatFolderRequest, ListFolderRequest, UploadFileRequest
except ImportError:
    raise ImproperlyConfigured("Could not load QCloud COS SDK.\n"
                               "See https://github.com/tencentyun/cos-python-sdk-v4")
